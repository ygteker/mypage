      ...
      <section className="education">
        ...
        <div className="education-item">
          ...
          <p>
            ...
            relation data analysis using the example of the coronavirus epidemic
          </p>
        </div>
      </section>
      ...
      <section className="experience">
        ...
        <div className="experience-item">
          ...
          <p>
            ...
            software dedicated to serving the public sector. To achieve this, I
            utilized modern technologies such as Quarkus with Java 17,
        ...
        <div className="experience-item">
          ...
          <p>
            ...
            implementation of these APIs contributed to improved efficiency and
        ...
        <div className="experience-item">
          ...
          <p>
            ...
            tailored monitoring solutions that met their specific requirements.
            To analyze and process data effectively, I utilized tools like SPL
            and influxDB on CentOS. Additionally, I ensured smooth data
            collection and visualization by implementing OpenTelemetry,
            empowering clients to optimize their systems and make informed
            decisions based on the insights provided by the monitoring software.
          </p>
        </div>
        <div className="experience-item">
          ...
          <p>
            ...
            services for the humanitarian organization, making a positive impact
            on both entities and their respective audiences.
          </p>
        </div>
      </section>
